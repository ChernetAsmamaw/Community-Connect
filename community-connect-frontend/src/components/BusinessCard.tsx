...
const BusinessCard: React.FC<BusinessCardProps> = ({ name, service, location }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto flex items-center justify-between border border-gray-200">
      {/* Picture Section */}
      ...
      <div className="flex-shrink-0">
        <button
          ...
          className="px-6 py-2 text-accent border border-gray-300 rounded-full hover:bg-secondary hover:text-white transition-colors"
        >
          Book Service
        </button>
      </div>
